  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 fade-in overflow-x-hidden">
      ...
      >
        ...
        >
          {showTitle ? (
            <div className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white min-w-0 flex-1 mr-2">
              {title}
            </div>
          ) : null}
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white rounded-full p-1 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex-shrink-0 transition-colors"

  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-6 fade-in">
      ...
      <div
        ...
        className={`relative bg-white dark:bg-gray-800 rounded-lg p-5 sm:p-6 ${widthClass} w-full shadow-xl ring-1 ring-gray-200 dark:ring-0 scale-in soft-shadow-md max-h-[calc(100dvh-3rem)] overflow-y-auto custom-scrollbar`}
      >
        <div
